...
# plot 3 - multiline chart
with(chartData, {
  plot(pTimes, chartData$Sub_metering_1, type = "l", xlab = "", ylab = "Energy sub metering")
  lines(pTimes, chartData$Sub_metering_2, col = "red")
  lines(pTimes, chartData$Sub_metering_3, col = "blue")
